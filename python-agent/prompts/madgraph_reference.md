...
## Using connect_to_madgraph()

The `connect_to_madgraph(script, timeout)` tool executes MadGraph5 commands.

**Input**: Multi-line string of MG5 commands OR path to .mg5 script file
...
0
"""
result = connect_to_madgraph(script)
```

### Example - BSM Model from UFO
...
```python
result = connect_to_madgraph("scripts/generate_ttbar.mg5")
```
